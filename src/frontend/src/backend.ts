...
export class Backend implements backendInterface {
    ...
    async getAllLeads(): Promise<Array<LeadPublic>> {
        if (this.processError) {
            try {
    ...
    async submitLead(arg0: string, arg1: string, arg2: string, arg3: boolean): Promise<LeadPublic> {
        if (this.processError) {
            try {
    ...
    async updateLeadAmountPaid(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLeadAmountPaid(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLeadPendingAmount(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLeadPendingAmount(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLeadSoldBy(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLeadSoldBy(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
